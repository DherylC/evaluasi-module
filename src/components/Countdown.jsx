...
export default function Countdown({ targetDate = "2026-08-06T21:00:00", event = "EVENT", doneMessage = "DONE!" }) {
    ...
    if (timeLeft.isFinished) {
        return (
            <div className="relative w-full max-w-xl mx-auto my-6 p-6 bg-red-500 border-4 border-black rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-center">
    ...
    return (
        <div className="relative w-full max-w-2xl mx-auto my-8 p-5 pt-7 sm:p-6 sm:pt-8 bg-yellow-300 border-3 sm:border-4 border-black rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-black select-none">
            ...
            <div className="grid grid-cols-4 gap-2 sm:gap-4 text-center">
                <TimeUnit label="Days" value={timeLeft.days} prevValue={prevTime.days} />
                <TimeUnit label="Hours" value={timeLeft.hours} prevValue={prevTime.hours} />
                <TimeUnit label="Mins" value={timeLeft.minutes} prevValue={prevTime.minutes} />
                <TimeUnit label="Secs" value={timeLeft.seconds} prevValue={prevTime.seconds} />
            </div>
        </div>
    );
}
...
function TimeUnit({ label, value, prevValue }) {
