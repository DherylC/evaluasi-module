...
import { SunIcon, Zap, Tornado } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-amber-300 flex items-center justify-center p-4 relative overflow-hidden font-sans selection:bg-yellow-400 selection:text-black">
            ...
            <main className="mt-20 relative z-10 w-full max-w-2xl bg-white border-4 border-black rounded-3xl p-6 sm:p-10 shadow-[10px_10px_0px_0px_rgba(0,0,0,1)]">
                ...
                <div className="mb-16 mt-8"> {/* part 1 */}
                    <div className="flex items-center justify-between border-b-4 border-black pb-4 mb-4">
                        <div className="flex items-center gap-2 bg-yellow-400 border-2 border-black px-3 py-1 font-black text-xs uppercase tracking-widest shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                            <Zap className="w-4 h-4 fill-current text-black" /> Pembukaan Briefing Day di ZOOM
                        </div>
                    </div>
                ...
                <div className="mb-16 mt-8"> {/* part 2 */}
                    <div className="flex items-center justify-between border-b-4 border-black pb-4 mb-4">
                        <div className="flex items-center gap-2 bg-yellow-400 border-2 border-black px-3 py-1 font-black text-xs uppercase tracking-widest shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                            <Zap className="w-4 h-4 fill-current text-black" /> Penayangan Trailer Storyline Act 1: The Signal
                        </div>
                    </div>
                ...
                <div className="mb-16 mt-8"> {/* part 3 */}
                    <div className="flex items-center justify-between border-b-4 border-black pb-4 mb-4">
                        <div className="flex items-center gap-2 bg-yellow-400 border-2 border-black px-3 py-1 font-black text-xs uppercase tracking-widest shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                            <Zap className="w-4 h-4 fill-current text-black" /> Breakout Room : Perkenalan Kelompok
                        </div>
                    </div>
                ...
                <div className="mb-16 mt-8"> {/* part 4 */}
                    <div className="flex items-center justify-between border-b-4 border-black pb-4 mb-4">
                        <div className="flex items-center gap-2 bg-yellow-400 border-2 border-black px-3 py-1 font-black text-xs uppercase tracking-widest shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                            <Zap className="w-4 h-4 fill-current text-black" /> Bridging Menuju Aktivitas Pemecahan Nama Kelompok
                        </div>
                    </div>
                ...
                <div className="mb-16 mt-8"> {/* part 5 */}
                    <div className="flex items-center justify-between border-b-4 border-black pb-4 mb-4">
                        <div className="flex items-center gap-2 bg-yellow-400 border-2 border-black px-3 py-1 font-black text-xs uppercase tracking-widest shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                            <Zap className="w-4 h-4 fill-current text-black" /> Aktivitas Pemecahan Nama Kelompok
                        </div>
                    </div>
                ...
                <div className="mt-8"> {/* part 6 */}
                    <div className="flex items-center justify-between border-b-4 border-black pb-4 mb-4">
                        <div className="flex items-center gap-2 bg-yellow-400 border-2 border-black px-3 py-1 font-black text-xs uppercase tracking-widest shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                            <Zap className="w-4 h-4 fill-current text-black" /> Reveal Nama Kelompok
                        </div>
                    </div>
