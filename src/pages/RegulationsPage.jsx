    ...
    },
    {
        ...
        cards: [
            ...
            },
            {
                id: 10,
                fullWidth: false,
                rule: "WAJIB menaati peraturan kampus yang berlaku",
...
export default function RegulationsPage() {
    ...
    return (
        <div className="min-h-screen bg-[#b80000] flex items-center justify-center p-4 sm:p-8 relative overflow-hidden font-sans selection:bg-yellow-400 selection:text-black">
                        ...
                        <div className="grid sm:grid-cols-2 gap-4 animate-fade-in" style={{ animationDelay: "100ms" }}>
                            {section.cards.map((card) => {
                                ...
                                return (
                                    <div
                                        key={card.id}
                                        className={`bg-white border-3 border-black rounded-2xl p-5 sm:p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all duration-150 flex flex-col justify-between text-zinc-900 ${widthClass}`}
                                    >
                                        {/* Main Text Content */}
